...
export const RichTextComponent = {
            ...
            return (
                <div className="relative w-full h-96 m-10 mx-auto">
                    <Image 
                        ...
                        alt="Image" /*Fix it later with better alt*/
                        fill
                    />
                </div>
            );
    ...
    block: {
        ...
        blockquote: ({ children }: any) => (
            <blockquote className="border-l-[#EFE335] border-l-4 pl-5 py-5 my-5">
                { children }
            </blockquote>
        ),
    },
        ...
        link: ({ children, value }: any) => {
            ...
            return (
                <Link 
                    href={ value.href }
                    rel={ rel }
                    className="underline decoration-[#EFE335] hover:decoration-black"
                >
                    { children }
                </Link>
            );
